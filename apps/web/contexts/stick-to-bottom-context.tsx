...
/*
    Adapted from https://github.com/stackblitz-labs/use-stick-to-bottom/tree/main

    New Feature: Added isAtTop and isNearTop to the state and context.
    This is used to determine if the component is at the top of the scrollable area.
    This is used to show the gradient at the top of the scrollable area.
    This is used to show the gradient at the bottom of the scrollable area.
    This is used to show the gradient at the top of the scrollable area.
*/
...
export const useStickToBottom = (
    ...
    const [isAtTop, updateIsAtTop] = useState(true);
                ...
                const promise = new Promise(requestAnimationFrame).then(() => {
                    ...
                    if (state.scrollTop < state.calculatedTargetScrollTop) {
                        return scrollToBottom({
                            ...
                            ignoreEscapes,
                            duration:
                                Math.max(0, durationElapsed - Date.now()) ||
                                undefined,
                        });
                    }
    ...
    const handleScroll = useCallback(
        ...
        [setEscapedFromLock, setIsAtBottom, setIsAtTop, isSelecting, state],
    );
    ...
    const contentRef = useRefCallback((content) => {
        ...
        state.resizeObserver = new ResizeObserver(([entry]) => {
            ...
            // Update isAtTop based on current scroll position
            if (state.isNearTop) {
                setIsAtTop(true);
            } else {
                setIsAtTop(false);
