...
import { useLinkedinEngagementData } from '@/hooks/use-dashboard-data';
import { Skeleton } from '@/components/ui/skeleton';
import { AlertCircle, InfoIcon } from 'lucide-react';
import { Alert, AlertDescription, AlertTitle } from '@/components/ui/alert';

interface LinkedinEngagementChartProps {
...
export function LinkedinEngagementChart({
    className,
}: LinkedinEngagementChartProps) {
    // Fetch data using our custom hook
    const { data, isLoading, isError } = useLinkedinEngagementData();
